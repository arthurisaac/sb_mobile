...
class BoxDetailsReservationScreen extends StatefulWidget {
  final Box box;
  final Order order;

  const BoxDetailsReservationScreen(
      {Key? key, required this.box, required this.order})
      : super(key: key);

  @override
  State<BoxDetailsReservationScreen> createState() =>
      _BoxDetailsReservationScreenState();
}

class _BoxDetailsReservationScreenState
    extends State<BoxDetailsReservationScreen> {
